...
Оценка и описание чего-то / кого-то
good - хороший
bad - плохой
...
Наречия для соединения предложений
поэтому - that’s why
однако - however 
...
function writeFile(resultArr) {
    ...
    for (const item of resultArr) {
        ws.addRow([item[0], item[1]]);
    }


    wb.xlsx
        .writeFile("./excel/English-words.xlsx")
        .then(() => {
